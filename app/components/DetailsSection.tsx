            ...
            <CardBody>
              ...
              >
                ...
                >
                  ...
                  />
                  <motion.div
                    className="absolute inset-8 rounded-full border border-gray-400/50"
                    variants={{
                      hover: {
                        rotate: -360,
                        transition: {
                  ...
                  >
                    <img
                      ...
                      src="https://ik.imagekit.io/drivex/PDF_Documents/ik_Vehicle_report_L0_L1/vehicle_image.png?updatedAt=1756978513834"
                      alt="Vehicle Image"
                    />
                  </motion.div>
                  ...
                  />
                  <motion.div
                    className="absolute bottom-8 left-8 w-2 h-2 rounded-full bg-gray-400"
                    variants={{
                      hover: {
                        scale: [1, 1.2, 1],
                        opacity: [0.7, 1, 0.7],
                  ...
                  />
                  <motion.div
                    className="absolute top-12 left-12 w-1.5 h-1.5 rounded-full bg-grey-400"
                    variants={{
                      hover: {
                        scale: [1, 1.8, 1],
                        opacity: [0.4, 1, 0.4],
